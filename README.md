...
<section class="view about">
  ...
  <ul>
    ...
    <li>2018 - 2022</li>
    <li data-es="Ingeniería Ambiental"
      data-en="Environmental Engineering"></li>
    <li data-es="TECH Universidad Tecnológica"
    ...
    <li>2024-2025</li>
    <li data-es="Universidad de Illinois Urbana-Champaign" 
      data-en="University of Illinois Urbana-Champaign"></li>
    <li>2025</li>
  ...
  <ul>
    ...
    <li>SQL</li>
    <li data-es="Programación estadística en R" 
      data-en="R Statistical Programming"> </li>
    <li> Tableau</li>
     <li> Looker Studio</li>
    <li>Excel / Power BI</li>
    <li data-es="Visualización de Datos" 
      data-en="Data Visualization"></li>
    <li data-es="Reportaje ESG (GRI, TCFD)" 
      data-en="ESG Reporting (GRI, TCFD)"></li>
    <li data-es="Cumplimiento normativo ambiental"
      data-en="Regulatory environmental compliance"></li>
...
<section class="view projects">
  ...
  <div class="full">
         <p data-es= "El cambio climático destaca como uno de los mayores desafíos del siglo XXI. En el centro de esta crisis se encuentran las emisiones de dióxido de carbono (CO₂)—producidas principalmente por la quema de combustibles fósiles—, que son el principal motor del calentamiento global. Los científicos y los responsables políticos están de acuerdo en que, si queremos evitar las consecuencias más devastadoras del cambio climático, debemos actuar con rapidez para reducir estas emisiones a escala global. Sin embargo, la forma en que entendemos y respondemos a este problema a menudo depende de cómo medimos dichas emisiones. Observar las emisiones anuales por país, comparar continentes o analizar datos históricos entre regiones y poblaciones puede pintar panorámicas muy distintas. Estas diversas perspectivas no solo cambian la narrativa, sino que pueden revelar información valiosa que nos ayuda a comprender las raíces del problema y nos guía hacia soluciones más eficaces."
      data-en="Climate change stands out as one of the greatest challenges of the 21st century. At the heart of this crisis are carbon dioxide (CO₂) emissions—primarily produced by burning fossil fuels—which are the leading driver of global warming. Scientists and policymakers agree that if we want to avoid the most devastating consequences of climate change, we must act quickly to reduce these emissions on a global scale.
...
<footer>
  © 2026 · Site created by: Javier Vargas
</footer>
